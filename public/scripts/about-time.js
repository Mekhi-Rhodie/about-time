...
$(document).ready(function () {
    $("#new-time").on("click", function (event) {
        ...
        $("#diff-output").slideDown(900).empty().append("<p class='timeDiff'>" + "<strong>" + "Start Time:" + "</strong>" + "   " + startTime + " " + "<strong>" + "End Time:" + "</strong>" + "   " + endTime + "</p>" + "<br>" + "<p class='timeDiff'>" + hourDifference + " Hours " + minDifference + " Minutes" + "</p>");
